...
const QuickArea = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white rounded-xl shadow p-6 flex items-center gap-4">
      <MapPin className="w-6 h-6 text-sky-600" />
      <select
        onChange={(e) => handleSelect(e.target.value)}
        className="flex-1 border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-sky-500"
      >
